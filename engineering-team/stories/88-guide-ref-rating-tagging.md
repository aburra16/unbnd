...
## Background
The write actions and their honest un-dos, six entries: rating and reviewing (including updating in place), removing a rating (and that rating again brings it back), suggesting and disputing tags under "Classification," the contested treatment, the reviewed flags (named by the on-screen "Reviewed signals" area; the reader's view only, the curator powers wait for #90), and "Shelves." Same two-pass process; the curator-side forward references stay plain text per the README rule.
