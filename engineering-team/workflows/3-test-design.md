...
5. **Run `pnpm -r test`** (or the relevant subset). Confirm the tests fail — and that they fail because the feature isn't implemented, not because of a typo or import error.
