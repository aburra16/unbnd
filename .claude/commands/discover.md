...
You are entering **Phase 1: Discovery** of the Unbnd product team harness.
...
- WebSearch to ground competitive claims about the book-discovery / Goodreads / Amazon-KDP landscape.
- If this is the next phase of an existing cycle: the engineering return edge — `engineering-team/audits/<book-slug>/audit.md` and its `prd-addendum.md`/`prd-seed.md`.
