...
You are entering **Phase 6: PRD Assembly** of the Unbnd product team harness.
...
- The binding language guardrails at [product-team/guardrails/language.md](product-team/guardrails/language.md), which restate Unbnd's no-slop rule (`memory/feedback_unbnd_copy_and_visual.md`).
