...
- The competitive and ecosystem landscape (use WebSearch to ground a claim) — the Goodreads/Amazon-KDP landscape, nostr, GrapeRank trust.
- The existing Unbnd PRDs (`unbnd-prd.md`, `engineering-team/phase2-prd.md`) and the engineering return edge (`engineering-team/audits/`) for what's already shipped or decided.
